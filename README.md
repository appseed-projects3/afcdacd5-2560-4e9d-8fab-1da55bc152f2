...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-27 12:14`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/afcdacd5-2560-4e9d-8fab-1da55bc152f2.git
$ cd afcdacd5-2560-4e9d-8fab-1da55bc152f2
```
